...
export default async function MyLessons() {
  ...
  // Only creators/admins should see this page
    ...
    <main className="mx-auto max-w-4xl px-6 py-12 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="rounded-xl bg-indigo-500 px-4 py-2 text-sm font-medium hover:bg-indigo-400"
        >
          New lesson
        </Link>
      </div>
          ...
          {lessons.map((l) => (
            <li key={l.id} className="flex flex-wrap items-center justify-between gap-3 p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link
                  href={`/creator/lessons/edit?id=${l.id}`}
